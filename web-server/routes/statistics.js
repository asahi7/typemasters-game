      ...
      include: [
        {
          model: models.RacePlayer,
          attributes: ["cpm"],
          where: { userUid: req.query.uid, isWinner: 1 }
        }
      ],
      where: { language: req.query.language }
    })
  ...
  async (req, res, next) => {
    ...
    return models.RacePlayer.findAll({
      ...
      attributes: [
        ...
        [
          models.sequelize.fn("AVG", models.sequelize.col("accuracy")),
          "accuracy"
        ],
        [
          models.sequelize.fn(
            "DATE_FORMAT",
            models.sequelize.col("race.date"),
            "%Y-%m-%d"
          ),
          "date"
        ]
